...
CREATE TABLE `companies` (
  ...
  `cover_photo` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `slogan` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `jobs` (
  ...
  `job_type` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `profiles` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `address` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `bio` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `contact_number` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `experience` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `education` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `qualifications` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `skillset` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `cover_letter` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `resume` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `recruiter_profiles` (
  ...
  `work_phone` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `address` varchar(191) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `users` (
  ...
  `profile_type` varchar(191) COLLATE utf8_unicode_ci DEFAULT NULL,
