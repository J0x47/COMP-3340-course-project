      ...
      <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-1">
            <a class="btn btn-success float-right" href="javascript:void(0)" id="createNewUser"> Create New Job Seeker</a>
          </div>
          <div class="card-body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ajaxAddUserForm" name="ajaxAddUserForm" class="form-horizontal">
                   <input type="hidden" name="user_type" id="add_user_type" value="1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ajaxEditUserForm" name="ajaxEditUserForm" class="form-horizontal">
                   ...
                   <input type="hidden" name="user_type" id="edit_user_type" value="1">
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('#dataTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.ajaxJobseeker.index') }}",
        columns: [
    ...
    $('#createNewUser').click(function () {
        ...
        $('#ajaxAddModelHeading').html("Create New User");
    ...
    $('#addUserBtn').click(function (e) {
        ...
        $.ajax({
          ...
          url: "{{ route('admin.ajaxJobseeker.store') }}",
          type: "POST",
          dataType: 'json',
    ...
    $('#saveBtn').click(function (e) {
        ...
        $.ajax({
          ...
          url: "{{ route('admin.ajaxJobseeker.update') }}",
          type: "POST",
          dataType: 'json',
          success: function (data) {
